...
namespace config
{
    float gfscale[] = { 1 / 5.851, 1 / 7.153, 1 / 8.368, 1 / 7.474, 1 / 6.014 , 1 / 6.823, 1 / 9.451, 1 / 8.996, 1 / 5.82, 1 / 6.239, 1 / 7.010,  1 / 7.711, 1 / 5.35, 1 / 6.235, 1 / 6.992, 1 / 7.462};
// scale WEV1 band1, band2, band3, band4; WFV2 band1, band 2......
    float gfoffset[] = {0.0039, 0.0047, 0.003,   0.0274, 0.0125, 0.0193, 0.0429,  0.011, 0.0071, 0.0334,0.0226, 0.0117,0.0369,   0.0235, 0.0217,  0.005};
// offset WEV1 band1, band2, band3, band4; WFV2 band1, band 2......

    float gfE0[] = { 1966.808, 1822.607, 1523.205, 1066.549};
}
